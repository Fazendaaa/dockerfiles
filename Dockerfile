...
ARG RETROARCH_FILE=${RETROARCH_VERSION}_RetroArch.7z
ENV ROOT_WWW_PATH /var/www/html

RUN cd ${ROOT_WWW_PATH} \
	&& wget https://buildbot.libretro.com/nightly/emscripten/${RETROARCH_FILE} \
	&& 7z e -y ${RETROARCH_FILE} \
	...
	&& ../../indexer > .index-xhr \
	&& rm -rf ${ROOT_WWW_PATH}/${RETROARCH_FILE} \
